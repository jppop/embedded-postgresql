...
#mvn install:install-file -DgeneratePom=true -Dfile=$RSRC_DIR/postgresql-Linux-x86_64.txz -DgroupId=org.postgresql.server -DartifactId=postgresql -Dversion=$VERSION -Dpackaging=txz -Dclassifier=Linux-x86_64
popd
...
#mvn install:install-file -DgeneratePom=true -Dfile=$RSRC_DIR/postgresql-Darwin-x86_64.txz -DgroupId=org.postgresql.server -DartifactId=postgresql -Dversion=$VERSION -Dpackaging=txz -Dclassifier=Darwin-x86_64
...
#mvn install:install-file -DgeneratePom=true -Dfile=$RSRC_DIR/postgresql-Windows-x86_64.txz -DgroupId=org.postgresql.server -DartifactId=postgresql -Dversion=$VERSION -Dpackaging=txz -Dclassifier=Windows-x86_64
popd
